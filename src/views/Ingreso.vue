    ...
    <v-layout justify-center mt-5>
        <v-flex xs12 sm8 md6 xl4>
            <v-card>
                ...
                <v-card-text>
                    <v-btn block @click="registro = true" color="warning" v-if="!registro">¿No tienes cuenta? Registrate aquí</v-btn>
                    <v-btn block @click="registro = false" color="secondary" v-if="registro">¿Ya tienes cuenta? Registrate aquí</v-btn>
                </v-card-text>
            </v-card>
        </v-flex>
    </v-layout>
